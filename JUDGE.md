...
| Tests | **234 vitest tests** in 9 s, of which **24 regression tests named after the defect they pin** (e.g. "a transactions timeout read as 'nothing on record'"), plus **13 fixtures** recorded live and replayed offline 13/13 with the same decision hash |
